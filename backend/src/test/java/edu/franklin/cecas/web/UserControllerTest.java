...
public class UserControllerTest {
    ...
    void testGetUserProfileRequiresAuthentication() throws Exception {
        mockMvc.perform(get("/api/users/me").with(anonymous())).andExpect(status().isUnauthorized());
    }
    ...
    void testStudentCannotGetStudentByStudentId() throws Exception {
        mockMvc.perform(get("/api/users/1001")).andExpect(status().isForbidden());
    }
    ...
    void testForceChangePasswordWithSeededPassword() throws Exception {
        ChangePasswordRequest req = new ChangePasswordRequest("ChairTemp01!", "newPassword", "newPassword");

        doNothing().when(userService).forceChangePassword(eq("chair@test.com"), any(ChangePasswordRequest.class));
    ...
    void testForceChangePasswordWrongCurrentPassword() throws Exception {
        ...
        ChangePasswordRequest req = new ChangePasswordRequest("wrongPassword", "newPassword", "newPassword");
    ...
    void testForceChangePasswordMismatch() throws Exception {
        ChangePasswordRequest req = new ChangePasswordRequest("ChairTemp01!", "newPassword", "differentPassword");
    ...
    void testStudentCannotAccessForceChangePassword() throws Exception {
        ...
        ChangePasswordRequest req = new ChangePasswordRequest("temp", "newPassword", "newPassword");
    ...
    void testNormalChangePasswordRequiresCorrectCurrentPassword() throws Exception {
        ...
        ChangePasswordRequest req = new ChangePasswordRequest("wrongCurrent", "newPassword", "newPassword");

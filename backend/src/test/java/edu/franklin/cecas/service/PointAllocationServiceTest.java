...
class PointAllocationServiceTest {
    ...
    void setUp() {
        ...
        pointAllocationService = new PointAllocationService(
                requestRepository,
                new ExtraCreditProperties(50));
    }
    ...
    void testGetPendingPointsIncludesEvidenceSubmittedRequests() {
        ExtraCreditRequest evidenceSubmitted = createRequest(
        ...
        verify(requestRepository).findByStudent_IdAndCourse_TermAndStatusIn(
                11,
                "26/FA",
                List.of(
                        ExtraCreditRequestStatus.PENDING,
    ...
    void testGetStudentPointsUpdatesAfterEvidenceIsApproved() {
        ExtraCreditRequest evidenceSubmitted = createRequest(
                ...
                5,
                null);
        ExtraCreditRequest approved = createRequest(
                ExtraCreditRequestStatus.APPROVED,
                5,
                3);

        when(requestRepository.findByStudent_IdAndCourse_TermAndStatus(
                11,
                "26/FA",
                ExtraCreditRequestStatus.APPROVED))
            .thenReturn(List.of())
